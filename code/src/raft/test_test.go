...
func TestRejoin2B(t *testing.T) {
	...
	leader1 := cfg.checkOneLeader()
	cfg.disconnect(leader1)
	fmt.Println("Tester: Disconnected ", leader1)
	...
	cfg.one(103, 2, true)
	fmt.Println("Tester: New leader commits entry with command 103, index=2 ")
	...
	// all together now
	cfg.connect(leader2)
	fmt.Println("Tester: Reconnected leader 2", leader2)
	fmt.Println("Tester: Leader 1 is ", leader1)
	//return
	...
	fmt.Println("Tester: Entry with command 105 replicated")
